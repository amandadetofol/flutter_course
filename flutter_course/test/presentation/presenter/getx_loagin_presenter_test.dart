...
void main() {
  ...
  test(
    ...
    () async {
      final emailError = expectLater(sut.emailErrorStream, emits(''));
      final passwordError = expectLater(sut.passwordErrorStream, emits(''));
      final formValid = expectLater(sut.isFormValidStream, emits(true));
  ...
  test(
    ...
    () async {
      ...
      final loadingPresentation = expectLater(
        sut.isLoadingStream,
        emitsInOrder(
          [true, false],
        ),
